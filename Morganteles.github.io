...
<head>
  ...
  <style>
    * {
    ...
    body {
      font-family: 'Arial', sans-serif;
      background: url('https://images.unsplash.com/photo-1603887271155-3c4b86b6bba5?auto=format&fit=crop&w=1280&q=80') no-repeat center center fixed;
...
<body>
  <div class="container">
    <img src="https://i.imgur.com/fxXrJzi.png" alt="Foto de Perfil" class="foto-perfil" />
    <div class="legenda">Morgan Teles</div>
    <h1>Bem-vindo ao meu cartão digital!</h1>
